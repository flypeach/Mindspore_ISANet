...
class Bottleneck(nn.Cell): # 迁移完成
    ...
    def __init__(self, inplanes, planes, stride = 1, downsample = None,
        ...
        self.conv2 = nn.Conv2d(in_channels=width, out_channels=width, kernel_size=3, stride=stride, has_bias=False, padding=dilation, dilation=dilation)
...
class ResNet(nn.Cell): # 迁移完成
    def __init__(
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=self.inplanes, kernel_size=7, stride=2, padding=3, has_bias=False)
